...
const LM = 'http://127.0.0.1:1234/v1/embeddings';
const MODEL = 'text-embedding-qwen3-embedding-4b';
const BATCH_SIZE = 1;
...
async function main() {
  ...
  const targetKeys = keys.length ? keys : ['majors', 'style_cases', 'policies_rules', 'province_data', 'score_rules', 'schools'];
